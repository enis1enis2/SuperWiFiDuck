...
(function() {
  ...
  var translations = {
    en: {
      ...
      "settings.prompt.staPassword": "STA Password (0-64 chars, empty for open network)",
    ...
    tr: {
      ...
      "settings.prompt.staPassword": "STA Sifresi (0-64 karakter, acik ag icin bos birak)",
